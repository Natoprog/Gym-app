      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="mb-6">
          ...
          <input
            type="text"
            id="exerciseName"
            {...register("exerciseName", { required: "Required" })}
        ...
        <button
          type="submit"
          className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-hidden focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 cursor-pointer"
        >
          Save
        </button>
      </form>
